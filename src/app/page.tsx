          ...
          <div className="glass-card rounded-xl p-2">
            <div className="flex items-center gap-3 px-4">
              ...
              <input
                ...
                className="flex-1 bg-transparent py-3 text-dark-50 placeholder:text-dark-200 focus:outline-none"
              />
              {searchQuery && (
                <button
        ...
        <section className="my-8">
          ...
          {filteredTools.length > 0 ? (
            ...
            <div className="glass-card rounded-xl p-12 text-center">
              ...
              <h3 className="mb-2 text-lg font-semibold text-dark-50">No tools found</h3>
              <p className="text-dark-200">Try adjusting your search or category filter</p>
            </div>
          )}
        </section>
